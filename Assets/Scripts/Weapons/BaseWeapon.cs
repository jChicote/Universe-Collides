...
{
    void Init(string id, WeaponData weaponData, VesselAudioSystem audioSystem, AimAssist aimAssist, ProjectileType projectileType);
...
public abstract class BaseWeapon : MonoBehaviour, IWeaponItem
{
    ...
    public virtual void Init(string id, WeaponData weaponData, VesselAudioSystem audioSystem, AimAssist aimAssist, ProjectileType projectileType) { }
